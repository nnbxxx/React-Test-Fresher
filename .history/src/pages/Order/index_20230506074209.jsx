...
const OrderPage = (props) => {
  ...
  const [carts, setCarts] = useState(useSelector((state) => state.order.carts));
  ...
  const handleOnChangeQuanlity = (value, book) => {
    if (!isNaN(value)) {
      console.log(
        "🚀 ~ file: index.jsx:190 ~ handleOnChangeQuanlity ~ value:",
        value
      );
      console.log(
        "🚀 ~ file: index.jsx:189 ~ handleOnChangeQuanlity ~ book:",
        book
      );

      /*dispatch(doUpdateBookAction({ value, detail: book, _id: book._id }));*/
    }
    return {};
  };
  return (
                        ...
                        return (
                          ...
                          >
                            ...
                            <InputNumber
                              ...
                              value={item.quanlity}
                              onChange={(value) => {
                                handleOnChangeQuanlity(value, item);
                              }}
                            ></InputNumber>
                            <div
