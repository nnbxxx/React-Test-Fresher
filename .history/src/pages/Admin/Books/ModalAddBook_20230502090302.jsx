...
const ModalAddBook = (props) => {
  ...
  const handleChangeThumnail = ({ fileListThumnail: newFileList }) => {
    console.log(
      "🚀 ~ file: ModalAddBook.jsx:23 ~ handleChangeThumnail ~ newFileList:",
      newFileList
    );
    return setfileListThumnail(newFileList);
  };
  const handleChangeSlider = ({ fileListSlider: newFileList }) => {
    console.log(
      "🚀 ~ file: ModalAddBook.jsx:27 ~ handleChangeSlider ~ newFileList:",
      newFileList
    );
